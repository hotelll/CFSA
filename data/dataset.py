    ...
    def __getitem__(self, index):
        ...
        if not self.load_video:
            sample = {
                # 'index': index,
                'data': data_path,
                'clips1': self.sample_clips(os.path.join(self.dataset_root, data_path_split[0])),
                'clips2': self.sample_clips(os.path.join(self.dataset_root, data_path_split[2])),
                ...
                # 'sublabels1': self.subclass_dict[data_path_split[1]],
                # 'sublabels2': self.subclass_dict[data_path_split[3]]
