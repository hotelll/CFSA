...
def train():
    ...
    for epoch in range(start_epoch, cfg.TRAIN.MAX_EPOCH):
        ...
        for iter, sample in enumerate(train_loader):
            ...
            # frame_seg1, frame_seg2 = consist_step_mining_inference(seq_features1, seq_features2, 12)
            loss_step, frame_seg1, frame_seg2 = consist_step_mining_train_pos(seq_features1, seq_features2, 12)
            loss_cls = compute_cls_loss(pred1, labels1) + compute_cls_loss(pred2, labels2)

            loss_frame = frame2step_loss(seq_features1, seq_features2, frame_seg2) \
                            + frame2step_loss(seq_features2, seq_features1, frame_seg1)
