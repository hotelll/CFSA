...
from models.adaK_learnStep_model import Align_adaK_learnStep
...
def eval():
    model = Align_adaK_learnStep(num_class=cfg.DATASET.NUM_CLASS,
...
def parse_args():
    ...
    args = parser.parse_args([
        ...
        '--root_path', 'train_logs/csv_logs/adaK_learnStep',
