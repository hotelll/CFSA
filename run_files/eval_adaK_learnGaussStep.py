...
from models.adaK_learnGaussStep_model import Align_adaK_learnGaussStep
...
def parse_args():
    ...
    args = parser.parse_args([
        '--config', 'configs/eval_adaK_learnGaussStep_config.yml',
        '--root_path', 'train_logs/csv_logs/adaK_learnGaussStep',
        # '--model_path', 'train_logs/csv_logs/align_adaK/best_model.tar',
        # '--model_path', '/home/nzl/CFSA/train_logs/csv_logs/adaK_learnGaussStep/4/save_models/best.tar',
        '--dist', 'adaK',
        '--start_epoch', '1'
    ])
