...
query_num_for_procedure = 20
ROOT_PATH = 'Datasets/Elastic-Matching-Simplified'
...
def choose_queries():
    ...
    for procedure in procedure_list:
        ...
        chosen_queries += sample(video_list, query_num_for_procedure)
...
def get_elastic_pair(pair_match_step, candidate_videos, chosen_queries, elastic_ratio):
    label_bank_path = 'Datasets/CSV/label_bank.json'
    label_bank = read_json(label_bank_path)
    elastic_pair_path = os.path.join(ROOT_PATH, 'elastic_pair_{}.txt'.format(elastic_ratio))
        ...
        for query in chosen_queries:
            ...
            for candidate in candidate_videos:
                ...
                if matched_label: # this is a positive pair
                    if pos_num < 100: # there isn't 100 positive pairs
                        f.writelines('{} {} {} {} {} {}/{}\n'.format(query_video, 
                                                                    query_label, 
                                                                    candidate_video, 
                                                                    candidate_label, 
